...
import { SafeAreaView, View, Text, StatusBar, StyleSheet, Platform, TouchableOpacity } from 'react-native';
    ...
    <SafeAreaView style={Estilo.safeArea}>
      ...
      <View style={Estilo.container}>
        ...
        <View style={Estilo.header}>
          {/* Botão de voltar */}
          <TouchableOpacity onPress={() => navigation.goBack()} style={Estilo.btnVoltar}>
            <Icon name="arrow-left" size={28} color="#FFD700" />
          </TouchableOpacity>
...
btnVoltar: {
  ...
  mainContent: { flex: 1, padding: 20, ...Platform.select({ web: { flexDirection: 'column', alignItems: 'center' } }) },
  menuRow: { flexDirection: 'row', justifyContent: 'space-around', marginBottom: 20, width: '100%', ...Platform.select({ web: { maxWidth: 600, marginBottom: 40 } }) },
});
