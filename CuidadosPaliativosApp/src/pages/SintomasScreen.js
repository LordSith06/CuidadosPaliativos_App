...
const Estilo = StyleSheet.create({
  ...
  headerText: { color: '#ffffff', fontSize: 24, fontWeight: '700' },
  ...
  labelLista: { color: '#37758a', fontSize: 17, fontWeight: '600' },

  linhaTitulo: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 10 },

  data: { color: "#37758a", fontSize: 16, fontWeight: "600" },

  item: { backgroundColor: '#ffffff', padding: 12, borderRadius: 10, marginBottom: 12, borderWidth: 1, borderColor: '#b6c4cc' },

  itemText: { color: '#37758a', fontSize: 16, marginLeft: 10 },

  checkboxArea: { flexDirection: 'row', alignItems: 'center' },

  checkbox: { width: 22, height: 22, borderRadius: 6, borderWidth: 2, borderColor: '#37758a', justifyContent: 'center', alignItems: 'center' },

  checkboxMarcado: { width: 12, height: 12, backgroundColor: '#37758a', borderRadius: 3 },

  acaoText: { marginTop: 8, color: '#2b6b87', backgroundColor: '#ffffff', padding: 10, borderRadius: 8, fontSize: 17, borderWidth: 1, borderColor: '#b6c4cc' },

  acaoCritica: { color: "red", fontWeight: "bold" },

  acaoPositiva: { color: "green", fontWeight: "bold" },

  acaoEstavel: { color: "#1d4e89", fontWeight: "bold" },

  alertaTexto: { marginTop: 20, padding: 15, backgroundColor: "#ffdddd", borderLeftWidth: 6, borderLeftColor: "red", color: "red", fontWeight: "bold", borderRadius: 8, fontSize: 16 },
});
