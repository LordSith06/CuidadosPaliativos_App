...
if arquivo:
    ...
    if colunas_numericas:
        ...
        # Histograma
        st.subheader("Histograma da variável")
        plt.hist(dados[coluna], bins=20)
    ...
    if len(colunas_numericas) >= 2:
        X = dados[colunas_numericas[:2]]  # Pega as 2 primeiras colunas numéricas para plotar
        y = dados[alvo]
